...
class HC:
    def __init__(self):
        with xr.open_dataarray('/projects/NS9853K/DATA/norkyst800/processed/hardanger/hc_coast.nc') as data:
            self.data   = data
            self.data_a = data
...
def calc():
    ...
    #combo   = xr.open_dataarray(tmp_path+'tmp_combo_fig7.nc')
...
def main():
    ...
    crps_ref = xr.open_dataset(tmp_path+'tmp_crps_clim_fig7_hk.nc').crps.mean('time')

...
def maps():
    ...
    for mlabel,months in zip(['winter','summer'],[winter_months,summer_months]):
        ...
        latex.save_figure(fig,'/nird/home/heau/figures_paper/062022_'+mlabel+t_alt+'_combo_NK_adjusted')
    ...
    for mlabel,months in zip(['winter','summer'],[winter_months,summer_months]):
        ...
        latex.save_figure(fig,'/nird/home/heau/figures_paper/062022'+mlabel+t_alt+'_combo_EC_adjusted')
